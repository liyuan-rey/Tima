...
#ifndef PJNSNTP_EXT_CLASS
#define PJNSNTP_EXT_CLASS
#endif
...
struct PJNSNTP_EXT_CLASS CNtpTimePacket
{
  DWORD m_dwInteger;
...
class PJNSNTP_EXT_CLASS CNtpTime
{
public:
...
struct PJNSNTP_EXT_CLASS NtpServerResponse
{
...
class PJNSNTP_EXT_CLASS CSNTPClient
{
public:
//Constructors / Destructors
  CSNTPClient();
